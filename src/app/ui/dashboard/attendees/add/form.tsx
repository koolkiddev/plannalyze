  ...
  return (
      <form action={addAttendee}>
        ...
        <div className="inline-flex ml-2 mt-0 md:px-4 mb-4">
          <button type="submit" className="transition transition-1 p-2 mr-2 bg-white font-medium rounded-lg outline outline-1 outline-slate-200 hover:bg-sky-100 hover:text-blue-600 mt-6">
            Add attendee
          </button>

          <Link href="/dashboard/attendees" className="transition transition-1 p-3 bg-white font-medium rounded-lg outline outline-1 outline-slate-200 hover:bg-sky-100 hover:text-blue-600 mt-6">
            Cancel
          </Link>
        </div>
      </form>
